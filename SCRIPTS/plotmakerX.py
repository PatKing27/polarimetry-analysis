...
# Create Sim Masks for X LOS.
# Create Sim masks. 
YZAbndsXI   = [int(512*(0.5 + (-10.0)/boxlenA)), int(512*(0.5 + (-7.2 )/boxlenA))]
YZAbndsXII  = [int(512*(0.5 + (-7.2 )/boxlenA)), int(512*(0.5 + (-4.0 )/boxlenA))]
YZAbndsXIII = [int(512*(0.5 + (-4.0 )/boxlenA)), int(512*(0.5 + ( 0.6 )/boxlenA))]
YZAbndsXIV  = [int(512*(0.5 + ( 0.6 )/boxlenA)), int(512*(0.5 + ( 4.0 )/boxlenA))]
YZAbndsXV   = [int(512*(0.5 + ( 4.0 )/boxlenA)), int(512*(0.5 + ( 5.6 )/boxlenA))]
YZAbndsXVI  = [int(512*(0.5 + ( 5.6 )/boxlenA)), int(512*(0.5 + ( 10.0)/boxlenA))]
YZAbndsYI   = [int(512*(0.5 + (-1.0 )/boxlenA)), int(512*(0.5 + ( 1.5 )/boxlenA))]
YZAbndsYII  = [int(512*(0.5 + (-1.2 )/boxlenA)), int(512*(0.5 + ( 2.0 )/boxlenA))]
YZAbndsYIII = [int(512*(0.5 + (-1.0 )/boxlenA)), int(512*(0.5 + ( 1.0 )/boxlenA))]
YZAbndsYIV  = [int(512*(0.5 + (-2.0 )/boxlenA)), int(512*(0.5 + ( 1.5 )/boxlenA))]
YZAbndsYV   = [int(512*(0.5 + (-1.4 )/boxlenA)), int(512*(0.5 + ( 1.5 )/boxlenA))]
YZAbndsYVI  = [int(512*(0.5 + (-1.4 )/boxlenA)), int(512*(0.5 + ( 0.5 )/boxlenA))]

YZBbndsXI   = [int(512*(0.5 + (-5.0)/boxlenB)), int(512*(0.5 +(-3.5)/boxlenB))]
YZBbndsXII  = [int(512*(0.5 + (-3.5)/boxlenB)), int(512*(0.5 +(-1.5)/boxlenB))]
YZBbndsXIII = [int(512*(0.5 + (-1.5)/boxlenB)), int(512*(0.5 + (0.5)/boxlenB))]
YZBbndsXIV  = [int(512*(0.5 +  (0.5)/boxlenB)), int(512*(0.5 + (2.0)/boxlenB))]
YZBbndsXV   = [int(512*(0.5 +  (2.0)/boxlenB)), int(512*(0.5 + (3.5)/boxlenB))]
YZBbndsXVI  = [int(512*(0.5 +  (3.5)/boxlenB)), int(512*(0.5 + (5.0)/boxlenB))]
YZBbndsYI   = [int(512*(0.5 + (-0.6)/boxlenB)), int(512*(0.5 + (0.6)/boxlenB))]
YZBbndsYII  = [int(512*(0.5 + (-1.0)/boxlenB)), int(512*(0.5 + (0.6)/boxlenB))]
YZBbndsYIII = [int(512*(0.5 + (-1.0)/boxlenB)), int(512*(0.5 +(0.45)/boxlenB))]
YZBbndsYIV  = [int(512*(0.5 + (-0.5)/boxlenB)), int(512*(0.5 + (1.0)/boxlenB))]
YZBbndsYV   = [int(512*(0.5 + (-0.4)/boxlenB)), int(512*(0.5 +(0.75)/boxlenB))]
YZBbndsYVI  = [int(512*(0.5 +(-0.45)/boxlenB)), int(512*(0.5 +(0.55)/boxlenB))]

YZCbndsXI   = [int(512*(0.5 + (-2.5 )/boxlenC)), int(512*(0.5 + (-2.1 )/boxlenC))]
YZCbndsXII  = [int(512*(0.5 + (-2.1 )/boxlenC)), int(512*(0.5 + (-1.1 )/boxlenC))]
YZCbndsXIII = [int(512*(0.5 + (-1.1 )/boxlenC)), int(512*(0.5 + ( 0.2 )/boxlenC))]
YZCbndsXIV  = [int(512*(0.5 + ( 0.2 )/boxlenC)), int(512*(0.5 + ( 1.2 )/boxlenC))]
YZCbndsXV   = [int(512*(0.5 + ( 1.2 )/boxlenC)), int(512*(0.5 + ( 2.5 )/boxlenC))]
YZCbndsYI   = [int(512*(0.5 + (-0.25)/boxlenC)), int(512*(0.5 + ( 0.25)/boxlenC))]
YZCbndsYII  = [int(512*(0.5 + (-0.25)/boxlenC)), int(512*(0.5 + ( 0.60)/boxlenC))]
YZCbndsYIII = [int(512*(0.5 + (-0.25)/boxlenC)), int(512*(0.5 + ( 0.20)/boxlenC))]
YZCbndsYIV  = [int(512*(0.5 + (-0.3 )/boxlenC)), int(512*(0.5 + ( 0.3 )/boxlenC))]
YZCbndsYV   = [int(512*(0.5 + (-0.25)/boxlenC)), int(512*(0.5 + ( 0.25)/boxlenC))]

YZDbnds    = [int(512*(0.5 +(-0.05)/boxlenD)),int(512*(0.5 +(0.05)/boxlenD))]

# Dilate masks depending on inclination angle.
if ang <= 45.0:
    YZAmask = np.zeros((N,N)).astype('bool')
    YZBmask = np.zeros((N,N)).astype('bool')
    YZCmask = np.zeros((N,N)).astype('bool')
    YZDmask = np.zeros((N,N)).astype('bool')
else:
    cscang = 1.0/np.sin(np.deg2rad(ang))
    YZAbndsYIrot   = [0.0,0.0]
    YZAbndsYIIrot  = [0.0,0.0]
    YZAbndsYIIIrot = [0.0,0.0]
    YZAbndsYIVrot  = [0.0,0.0]
    YZAbndsYVrot   = [0.0,0.0]
    YZAbndsYVIrot  = [0.0,0.0]
    YZBbndsYIrot   = [0.0,0.0]
    YZBbndsYIIrot  = [0.0,0.0]
    YZBbndsYIIIrot = [0.0,0.0]
    YZBbndsYIVrot  = [0.0,0.0]
    YZBbndsYVrot   = [0.0,0.0]
    YZBbndsYVIrot  = [0.0,0.0]
    YZCbndsYIrot   = [0.0,0.0]
    YZCbndsYIIrot  = [0.0,0.0]
    YZCbndsYIIIrot = [0.0,0.0]
    YZCbndsYIVrot  = [0.0,0.0]
    YZCbndsYVrot   = [0.0,0.0]
    YZDbndsrot     = [0.0,0.0]

    YZAbndsYIrot[0]   =   YZAbndsYI[0]*(1.0 -(cscang-1.0))
    YZAbndsYIIrot[0]  =  YZAbndsYII[0]*(1.0 -(cscang-1.0))
    YZAbndsYIIIrot[0] = YZAbndsYIII[0]*(1.0 -(cscang-1.0))
    YZAbndsYIVrot[0]  =  YZAbndsYIV[0]*(1.0 -(cscang-1.0))
    YZAbndsYVrot[0]   =   YZAbndsYV[0]*(1.0 -(cscang-1.0))
    YZAbndsYVIrot[0]  =  YZAbndsYVI[0]*(1.0 -(cscang-1.0))
    YZAbndsYIrot[1]   =   YZAbndsYI[1]*(1.0 +(cscang-1.0))
    YZAbndsYIIrot[1]  =  YZAbndsYII[1]*(1.0 +(cscang-1.0))
    YZAbndsYIIIrot[1] = YZAbndsYIII[1]*(1.0 +(cscang-1.0))
    YZAbndsYIVrot[1]  =  YZAbndsYIV[1]*(1.0 +(cscang-1.0))
    YZAbndsYVrot[1]   =   YZAbndsYV[1]*(1.0 +(cscang-1.0))
    YZAbndsYVIrot[1]  =  YZAbndsYVI[1]*(1.0 +(cscang-1.0))

    YZBbndsYIrot[0]   =   YZBbndsYI[0]*(1.0 -(cscang-1.0))
    YZBbndsYIIrot[0]  =  YZBbndsYII[0]*(1.0 -(cscang-1.0))
    YZBbndsYIIIrot[0] = YZBbndsYIII[0]*(1.0 -(cscang-1.0))
    YZBbndsYIVrot[0]  =  YZBbndsYIV[0]*(1.0 -(cscang-1.0))
    YZBbndsYVrot[0]   =   YZBbndsYV[0]*(1.0 -(cscang-1.0))
    YZBbndsYVIrot[0]  =  YZBbndsYVI[0]*(1.0 -(cscang-1.0))
    YZBbndsYIrot[1]   =   YZBbndsYI[1]*(1.0 +(cscang-1.0))
    YZBbndsYIIrot[1]  =  YZBbndsYII[1]*(1.0 +(cscang-1.0))
    YZBbndsYIIIrot[1] = YZBbndsYIII[1]*(1.0 +(cscang-1.0))
    YZBbndsYIVrot[1]  =  YZBbndsYIV[1]*(1.0 +(cscang-1.0))
    YZBbndsYVrot[1]   =   YZBbndsYV[1]*(1.0 +(cscang-1.0))
    YZBbndsYVIrot[1]  =  YZBbndsYVI[1]*(1.0 +(cscang-1.0))

    YZCbndsYIrot[0]   =   YZCbndsYI[0]*(1.0 -(cscang-1.0))
    YZCbndsYIIrot[0]  =  YZCbndsYII[0]*(1.0 -(cscang-1.0))
    YZCbndsYIIIrot[0] = YZCbndsYIII[0]*(1.0 -(cscang-1.0))
    YZCbndsYIVrot[0]  =  YZCbndsYIV[0]*(1.0 -(cscang-1.0))
    YZCbndsYVrot[0]   =   YZCbndsYV[0]*(1.0 -(cscang-1.0))
    YZCbndsYIrot[1]   =   YZCbndsYI[1]*(1.0 +(cscang-1.0))
    YZCbndsYIIrot[1]  =  YZCbndsYII[1]*(1.0 +(cscang-1.0))
    YZCbndsYIIIrot[1] = YZCbndsYIII[1]*(1.0 +(cscang-1.0))
    YZCbndsYIVrot[1]  =  YZCbndsYIV[1]*(1.0 +(cscang-1.0))
    YZCbndsYVrot[1]   =   YZCbndsYV[1]*(1.0 +(cscang-1.0))

    YZDbndsrot[0]     =     YZDbnds[0]*(1.0 -(cscang-1.0))
    YZDbndsrot[1]     =     YZDbnds[1]*(1.0 +(cscang-1.0))

    YZAmask = np.ones((N,N)).astype('bool')
    YZBmask = np.ones((N,N)).astype('bool')
    YZCmask = np.ones((N,N)).astype('bool')
    YZDmask = np.ones((N,N)).astype('bool')
    for k in range(N):
        if YZDbndsrot[0] <= k <= YZDbndsrot[1]:
            YZDmask[:,k] = False
        if YZBbndsYIrot[0]   <= k <= YZBbndsYIrot[1]:
            for l in range(N):
                if YZBbndsXI[0]   <= l <= YZBbndsXI[1]:
                    YZBmask[l,k] = False
        if YZBbndsYIIrot[0]  <= k <= YZBbndsYIIrot[1]:
            for l in range(N):
                if YZBbndsXII[0]  <= l <= YZBbndsXII[1]:
                    YZBmask[l,k] = False
        if YZBbndsYIIIrot[0] <= k <= YZBbndsYIIIrot[1]:
            for l in range(N):
                if YZBbndsXIII[0] <= l <= YZBbndsXIII[1]:
                    YZBmask[l,k] = False
        if YZBbndsYIVrot[0]  <= k <= YZBbndsYIVrot[1]:
            for l in range(N):
                if YZBbndsXIV[0]  <= l <= YZBbndsXIV[1]:
                    YZBmask[l,k] = False
        if YZBbndsYVrot[0]   <= k <= YZBbndsYVrot[1]:
            for l in range(N):
                if YZBbndsXV[0]   <= l <= YZBbndsXV[1]:
                    YZBmask[l,k] = False
        if YZBbndsYVIrot[0]  <= k <= YZBbndsYVIrot[1]:
            for l in range(N):
                if YZBbndsXVI[0]  <= l <= YZBbndsXVI[1]:
                    YZBmask[l,k] = False
        if YZCbndsYIrot[0]   <= k <= YZCbndsYIrot[1]:
            for l in range(N):
                if YZCbndsXI[0]   <= l <= YZCbndsXI[1]:
                    YZCmask[l,k] = False
        if YZCbndsYIIrot[0]  <= k <= YZCbndsYIIrot[1]:
            for l in range(N):
                if YZCbndsXII[0]  <= l <= YZCbndsXII[1]:
                    YZCmask[l,k] = False
        if YZCbndsYIIIrot[0] <= k <= YZCbndsYIIIrot[1]:
            for l in range(N):
                if YZCbndsXIII[0] <= l <= YZCbndsXIII[1]:
                    YZCmask[l,k] = False
        if YZCbndsYIVrot[0]  <= k <= YZCbndsYIVrot[1]:
            for l in range(N):
                if YZCbndsXIV[0]  <= l <= YZCbndsXIV[1]:
                    YZCmask[l,k] = False
        if YZCbndsYVrot[0]   <= k <= YZCbndsYVrot[1]:
            for l in range(N):
                if YZCbndsXV[0]   <= l <= YZCbndsXV[1]:
                    YZCmask[l,k] = False
        if YZAbndsYIrot[0]   <= k <= YZAbndsYIrot[1]:
            for l in range(N):
                if YZAbndsXI[0]   <= l <= YZAbndsXI[1]:
                    YZAmask[l,k] = False
        if YZAbndsYIIrot[0]  <= k <= YZAbndsYIIrot[1]:
            for l in range(N):
                if YZAbndsXII[0]  <= l <= YZAbndsXII[1]:
                    YZAmask[l,k] = False
        if YZAbndsYIIIrot[0] <= k <= YZAbndsYIIIrot[1]:
            for l in range(N):
                if YZAbndsXIII[0] <= l <= YZAbndsXIII[1]:
                    YZAmask[l,k] = False
        if YZAbndsYIVrot[0]  <= k <= YZAbndsYIVrot[1]:
            for l in range(N):
                if YZAbndsXIV[0]  <= l <= YZAbndsXIV[1]:
                    YZAmask[l,k] = False
        if YZAbndsYVrot[0]   <= k <= YZAbndsYVrot[1]:
            for l in range(N):
                if YZAbndsXV[0]   <= l <= YZAbndsXV[1]:
                    YZAmask[l,k] = False
        if YZAbndsYVIrot[0]  <= k <= YZAbndsYVIrot[1]:
            for l in range(N):
                if YZAbndsXVI[0]  <= l <= YZAbndsXVI[1]:
                    YZAmask[l,k] = False
    #YZBmask = np.flip(YZBmask,1)
    #YZAmask = np.flip(YZAmask,1)
    #YZCmask = np.flip(YZCmask,1)
    #YZDmask = np.flip(YZDmask,1)
...
fileNA  = open('N_YZ_A_stats.txt', 'w')
filepA  = open('p_YZ_A_stats.txt', 'w')
fileSA  = open('S_YZ_A_stats.txt', 'w')
fileNpA = open('Np_YZ_A_stats.txt', 'w')
fileNSA = open('NS_YZ_A_stats.txt', 'w')
fileSpA = open('Sp_YZ_A_stats.txt', 'w')
...
UA = ObsA[2]
pA = ObsA[6]
CDA.data = np.ma.masked_array(CDA.data, YZAmask)
QA.data  = np.ma.masked_array(QA.data,  YZAmask)
UA.data  = np.ma.masked_array(UA.data,  YZAmask)
pA.data  = np.ma.masked_array(pA.data,  YZAmask)
SA = NA.ComputeAngleGradient(QA, UA,    YZAmask)
PltA = Plotter([N, boxlenA, 5, 100, './'])
PltA.Imager(CDA, 'CDAhomo')
PltA.Imager(pA, 'pAhomo')
PltA.Imager(SA, 'SAhomo')
# 1D KDE.
...
# Save 1D KDE.
St.Save1DKDE(xNA, fNA, 'N_YZ_A_homo')
St.Save1DKDE(xpA, fpA, 'p_YZ_A_homo')
St.Save1DKDE(xSA, fSA, 'S_YZ_A_homo')
# Save 2D KDE. 
St.Save2DKDE(xxNpA, yyNpA, fNpA, 'Np_YZ_A_homo', 'Gaussian')
St.Save2DKDE(xxNSA, yyNSA, fNSA, 'NS_YZ_A_homo', 'Gaussian')
St.Save2DKDE(xxSpA, yySpA, fSpA, 'Sp_YZ_A_homo', 'Gaussian')       
# plotting. 
...
for i in range(len(indices)):
    for j in range(len(cutoffs)):
        ...
        pA.data  = np.ma.masked_array(pA.data,  YZAmask)
        SA  = NA.ComputeAngleGradient(QA, UA,   YZAmask)
        PltA.Imager(CDA, 'CDA_'+str(j)+'_'+str(i))
        PltA.Imager(pA, 'pA_'+str(j)+'_'+str(i))
        PltA.Imager(SA, 'SA_'+str(j)+'_'+str(i))
        # 1D KDE.
        xNA, fNA = St.Gaussian1DKDE(np.log10(np.ma.compressed(CDA.data)), Nbnds)
        xpA, fpA = St.Gaussian1DKDE(np.log10(np.ma.compressed(pA.data)), pbnds)
        xSA, fSA = St.Gaussian1DKDE(np.log10(np.ma.compressed(SA.data)), Sbnds)
        ...
        fileSpA.write('Homogeneous, {: f}, {: f}, {: f}, {: f}, {: f}, {: f}, {: f}, {: f} \n'.format(SpAeval[1], SpAevec[1,0], SpAevec[1,1], SpAeval[0], SpAevec[0,0], SpAevec[0,1], SpApr, SpAsr))
        # Save 1D KDE.
        St.Save1DKDE(xNA, fNA, 'N_YZ_A_ind'+str(i)+'_cut'+str(j))
        St.Save1DKDE(xpA, fpA, 'p_YZ_A_ind'+str(i)+'_cut'+str(j))
        St.Save1DKDE(xSA, fSA, 'S_YZ_A_ind'+str(i)+'_cut'+str(j))
        # Save 2D KDE. 
        St.Save2DKDE(xxNpA, yyNpA, fNpA, 'Np_YZ_A_ind'+str(i)+'_cut'+str(j), 'Gaussian')
        St.Save2DKDE(xxNSA, yyNSA, fNSA, 'NS_YZ_A_ind'+str(i)+'_cut'+str(j), 'Gaussian')
        St.Save2DKDE(xxSpA, yySpA, fSpA, 'Sp_YZ_A_ind'+str(i)+'_cut'+str(j), 'Gaussian')       
        # plotting. 
        if j == 0:
...
# Open files to write stats to.
fileNB  = open('N_YZ_B_stats.txt', 'w')
filepB  = open('p_YZ_B_stats.txt', 'w')
fileSB  = open('S_YZ_B_stats.txt', 'w')
fileNpB = open('Np_YZ_B_stats.txt', 'w')
fileNSB = open('NS_YZ_B_stats.txt', 'w')
fileSpB = open('Sp_YZ_B_stats.txt', 'w')
...
UB = ObsB[2]
pB = ObsB[6]
CDB.data = np.ma.masked_array(CDB.data, YZBmask)
QB.data  = np.ma.masked_array(QB.data,  YZBmask)
UB.data  = np.ma.masked_array(UB.data,  YZBmask)
pB.data  = np.ma.masked_array(pB.data,  YZBmask)
SB = NB.ComputeAngleGradient(QB, UB,    YZBmask)
PltB = Plotter([N, boxlenB, 5, 100, './'])
PltB.Imager(CDB, 'CDBhomo')
PltB.Imager(pB, 'pBhomo')
PltB.Imager(SB, 'SBhomo')
# 1D KDE.
...
# Save 1D KDE.
St.Save1DKDE(xNB, fNB, 'N_YZ_B_homo')
St.Save1DKDE(xpB, fpB, 'p_YZ_B_homo')
St.Save1DKDE(xSB, fSB, 'S_YZ_B_homo')
# Save 2D KDE. 
St.Save2DKDE(xxNpB, yyNpB, fNpB, 'Np_YZ_B_homo', 'Gaussian')
St.Save2DKDE(xxNSB, yyNSB, fNSB, 'NS_YZ_B_homo', 'Gaussian')
St.Save2DKDE(xxSpB, yySpB, fSpB, 'Sp_YZ_B_homo', 'Gaussian')     
# plotting. 
...
for i in range(len(indices)):
    for j in range(len(cutoffs)):
        ...
        pB.data  = np.ma.masked_array(pB.data,  YZBmask)
        SB  = NB.ComputeAngleGradient(QB, UB,   YZBmask)
        PltB.Imager(CDB, 'CDB_'+str(j)+'_'+str(i))
        PltB.Imager(pB, 'pB_'+str(j)+'_'+str(i))
        PltB.Imager(SB, 'SB_'+str(j)+'_'+str(i))
        # 1D KDE.
        xNB, fNB = St.Gaussian1DKDE(np.log10(np.ma.compressed(CDB.data)), Nbnds)
        xpB, fpB = St.Gaussian1DKDE(np.log10(np.ma.compressed(pB.data)), pbnds)
        xSB, fSB = St.Gaussian1DKDE(np.log10(np.ma.compressed(SB.data)), Sbnds)
        ...
        fileSpB.write('Homogeneous, {: f}, {: f}, {: f}, {: f}, {: f}, {: f}, {: f}, {: f} \n'.format(SpBeval[1], SpBevec[1,0], SpBevec[1,1], SpBeval[0], SpBevec[0,0], SpBevec[0,1], SpBpr, SpBsr))  
        # Save 1D KDE.
        St.Save1DKDE(xNB, fNB, 'N_YZ_B_ind'+str(i)+'_cut'+str(j))
        St.Save1DKDE(xpB, fpB, 'p_YZ_B_ind'+str(i)+'_cut'+str(j))
        St.Save1DKDE(xSB, fSB, 'S_YZ_B_ind'+str(i)+'_cut'+str(j))
        # Save 2D KDE. 
        St.Save2DKDE(xxNpB, yyNpB, fNpB, 'Np_YZ_B_ind'+str(i)+'_cut'+str(j), 'Gaussian')
        St.Save2DKDE(xxNSB, yyNSB, fNSB, 'NS_YZ_B_ind'+str(i)+'_cut'+str(j), 'Gaussian')
        St.Save2DKDE(xxSpB, yySpB, fSpB, 'Sp_YZ_B_ind'+str(i)+'_cut'+str(j), 'Gaussian')        
        # plotting. 
        if j == 0:
...
# open files to write stats to.
fileNC  = open('N_YZ_C_stats.txt', 'w')
filepC  = open('p_YZ_C_stats.txt', 'w')
fileSC  = open('S_YZ_C_stats.txt', 'w')
fileNpC = open('Np_YZ_C_stats.txt', 'w')
fileNSC = open('NS_YZ_C_stats.txt', 'w')
fileSpC = open('Sp_YZ_C_stats.txt', 'w')
...
UC = ObsC[2]
pC = ObsC[6]
CDC.data = np.ma.masked_array(CDC.data, YZCmask)
QC.data  = np.ma.masked_array(QC.data,  YZCmask)
UC.data  = np.ma.masked_array(UC.data,  YZCmask)
pC.data  = np.ma.masked_array(pC.data,  YZCmask)
SC = NC.ComputeAngleGradient(QC, UC,    YZCmask)
PltC = Plotter([N, boxlenC, 5, 100, './'])
PltC.Imager(CDC, 'CDChomo')
PltC.Imager(pC, 'pChomo')
PltC.Imager(SC, 'SChomo')
# 1D KDE.
...
# Save 1D KDE.
St.Save1DKDE(xNC, fNC, 'N_YZ_C_homo')
St.Save1DKDE(xpC, fpC, 'p_YZ_C_homo')
St.Save1DKDE(xSC, fSC, 'S_YZ_C_homo')
# Save 2D KDE. 
St.Save2DKDE(xxNpC, yyNpC, fNpC, 'Np_YZ_C_homo', 'Gaussian')
St.Save2DKDE(xxNSC, yyNSC, fNSC, 'NS_YZ_C_homo', 'Gaussian')
St.Save2DKDE(xxSpC, yySpC, fSpC, 'Sp_YZ_C_homo', 'Gaussian')       
# plotting. 
...
for i in range(len(indices)):
    for j in range(len(cutoffs)):
        ...
        pC.data  = np.ma.masked_array(pC.data,  YZCmask)
        SC  = NC.ComputeAngleGradient(QC, UC,   YZCmask)
        PltC.Imager(CDC, 'CDC_'+str(j)+'_'+str(i))
        PltC.Imager(pC, 'pC_'+str(j)+'_'+str(i))
        PltC.Imager(SC, 'SC_'+str(j)+'_'+str(i))
        # 1D KDE.
        xNC, fNC = St.Gaussian1DKDE(np.log10(np.ma.compressed(CDC.data)), Nbnds)
        xpC, fpC = St.Gaussian1DKDE(np.log10(np.ma.compressed(pC.data)), pbnds)
        xSC, fSC = St.Gaussian1DKDE(np.log10(np.ma.compressed(SC.data)), Sbnds)
        ...
        fileSpC.write('Homogeneous, {: f}, {: f}, {: f}, {: f}, {: f}, {: f}, {: f}, {: f} \n'.format(SpCeval[1], SpCevec[1,0], SpCevec[1,1], SpCeval[0], SpCevec[0,0], SpCevec[0,1], SpCpr, SpCsr))  
        # Save 1D KDE.
        St.Save1DKDE(xNC, fNC, 'N_YZ_C_ind'+str(i)+'_cut'+str(j))
        St.Save1DKDE(xpC, fpC, 'p_YZ_C_ind'+str(i)+'_cut'+str(j))
        St.Save1DKDE(xSC, fSC, 'S_YZ_C_ind'+str(i)+'_cut'+str(j))
        # Save 2D KDE. 
        St.Save2DKDE(xxNpC, yyNpC, fNpC, 'Np_YZ_C_ind'+str(i)+'_cut'+str(j), 'Gaussian')
        St.Save2DKDE(xxNSC, yyNSC, fNSC, 'NS_YZ_C_ind'+str(i)+'_cut'+str(j), 'Gaussian')
        St.Save2DKDE(xxSpC, yySpC, fSpC, 'Sp_YZ_C_ind'+str(i)+'_cut'+str(j), 'Gaussian')         
        # plotting. 
        if j == 0:
...
# Open files to write stats to.
fileND  = open('N_YZ_D_stats.txt', 'w')
filepD  = open('p_YZ_D_stats.txt', 'w')
fileSD  = open('S_YZ_D_stats.txt', 'w')
fileNpD = open('Np_YZ_D_stats.txt', 'w')
fileNSD = open('NS_YZ_D_stats.txt', 'w')
fileSpD = open('Sp_YZ_D_stats.txt', 'w')
...
UD = ObsD[2]
pD = ObsD[6]
CDD.data = np.ma.masked_array(CDD.data, YZDmask)
QD.data  = np.ma.masked_array(QD.data,  YZDmask)
UD.data  = np.ma.masked_array(UD.data,  YZDmask)
pD.data  = np.ma.masked_array(pD.data,  YZDmask)
SD = ND.ComputeAngleGradient(QD, UD,    YZDmask)
PltD = Plotter([N, boxlenD, 5, 100, './'])
PltD.Imager(CDD, 'CDDhomo')
PltD.Imager(pD, 'pDhomo')
PltD.Imager(SD, 'SDhomo')
# 1D KDE.
...
# Save 1D KDE.
St.Save1DKDE(xND, fND, 'N_YZ_D_homo')
St.Save1DKDE(xpD, fpD, 'p_YZ_D_homo')
St.Save1DKDE(xSD, fSD, 'S_YZ_D_homo')
# Save 2D KDE. 
St.Save2DKDE(xxNpD, yyNpD, fNpD, 'Np_YZ_D_homo', 'Gaussian')
St.Save2DKDE(xxNSD, yyNSD, fNSD, 'NS_YZ_D_homo', 'Gaussian')
St.Save2DKDE(xxSpD, yySpD, fSpD, 'Sp_YZ_D_homo', 'Gaussian')     
# plotting. 
...
for i in range(len(indices)):
    for j in range(len(cutoffs)):
        ...
        pD.data  = np.ma.masked_array(pD.data,  YZDmask)
        SD  = ND.ComputeAngleGradient(QD, UD,   YZDmask)
        PltD.Imager(CDD, 'CDD_'+str(j)+'_'+str(i))
        PltD.Imager(pD, 'pD_'+str(j)+'_'+str(i))
        PltD.Imager(SD, 'SD_'+str(j)+'_'+str(i))
        # 1D KDE.
        xND, fND = St.Gaussian1DKDE(np.log10(np.ma.compressed(CDD.data)), Nbnds)
        xpD, fpD = St.Gaussian1DKDE(np.log10(np.ma.compressed(pD.data)), pbnds)
        xSD, fSD = St.Gaussian1DKDE(np.log10(np.ma.compressed(SD.data)), Sbnds)
        ...
        fileSpD.write('Homogeneous, {: f}, {: f}, {: f}, {: f}, {: f}, {: f}, {: f}, {: f} \n'.format(SpDeval[1], SpDevec[1,0], SpDevec[1,1], SpDeval[0], SpDevec[0,0], SpDevec[0,1], SpDpr, SpDsr))     
        # Save 1D KDE.
        St.Save1DKDE(xND, fND, 'N_YZ_D_ind'+str(i)+'_cut'+str(j))
        St.Save1DKDE(xpD, fpD, 'p_YZ_D_ind'+str(i)+'_cut'+str(j))
        St.Save1DKDE(xSD, fSD, 'S_YZ_D_ind'+str(i)+'_cut'+str(j))
        # Save 2D KDE. 
        St.Save2DKDE(xxNpD, yyNpD, fNpD, 'Np_YZ_D_ind'+str(i)+'_cut'+str(j), 'Gaussian')
        St.Save2DKDE(xxNSD, yyNSD, fNSD, 'NS_YZ_D_ind'+str(i)+'_cut'+str(j), 'Gaussian')
        St.Save2DKDE(xxSpD, yySpD, fSpD, 'Sp_YZ_D_ind'+str(i)+'_cut'+str(j), 'Gaussian')    
        # plotting. 
        if j == 0:
...
figp.savefig('pPLYZ.png')
figS.savefig('SPLYZ.png')
figNp.savefig('NpPLYZ.png')
figSp.savefig('SpPLYZ.png')
figNS.savefig('NSPLYZ.png')
